...
>(({ className, variant = 'default', ...props }, ref) => (
    <ToastPrimitives.Root
        ref={ref}
        className={cn(
            'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border p-4 shadow-lg transition-all animate-slide-in',
            ...
            variant === 'success' && 'border-emerald-500/50 bg-emerald-500 text-white',
            className,
        )}
        {...props}
    />
